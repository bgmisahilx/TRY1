...
def reset_daily_counts():
    ...
    ist_now = utc.astimezone(timezone(timedelta(hours=5, minutes=10)))
...
def bgmi_command(message, bot):
    try:
        ...
        command = f'./sasuke {target_ip} {target_port} {default_duration}'
...
bot = TeleBot(7690966712:AAEAQ1ZE3iKB9MRW0pbO8JGdKw2lDB0l1Jg)
user_attacks = {}
user_cooldowns = {}
user_photos = []
user_bans = {}
